...
func TestKind(t *testing.T) {
	feat := features.New("Create Dask cluster").
		WithSetup("Deploy controller", func(ctx context.Context, t *testing.T, cfg *envconf.Config) context.Context {
			...
			role := rbacv1.ClusterRole{
				ObjectMeta: metav1.ObjectMeta{Name: "dask-controller"},
		...
		WithSetup("Create cluster", func(ctx context.Context, t *testing.T, cfg *envconf.Config) context.Context {
