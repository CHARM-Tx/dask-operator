...
RUN --mount=type=cache,target=/root/.cache/go-build  go install \
	k8s.io/code-generator/cmd/client-gen@v${K8S_CODEGEN_VERSION} \
	k8s.io/code-generator/cmd/deepcopy-gen@v${K8S_CODEGEN_VERSION} \
	k8s.io/code-generator/cmd/lister-gen@v${K8S_CODEGEN_VERSION} \
	k8s.io/code-generator/cmd/informer-gen@v${K8S_CODEGEN_VERSION} \
	k8s.io/code-generator/cmd/applyconfiguration-gen@v${K8S_CODEGEN_VERSION} \
